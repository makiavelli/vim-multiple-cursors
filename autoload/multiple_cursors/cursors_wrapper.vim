...
" cursorsWrapper prototype {{{
	...
	"==================================================
	" To retrieve a NEW instance of this object call: multiple_cursors#cursors_wrapper#getObject()
	"
	" es. let s:my_fucking_obj = multiple_cursors#cursors_wrapper#getObject()
